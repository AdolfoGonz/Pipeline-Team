...
const MacotaController_1 = __importDefault(require("./controllers/MacotaController"));
...
const server = new Server_1.default({
    ...
    controllers: [MacotaController_1.default.instance, ProductoMascotaController_1.default.instance],
});
server.init();
